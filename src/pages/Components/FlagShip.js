  ...
  return (
    <>
      ...
      <div className='bg-flagship h-[88vh] bg-cover bg-center relative'>
        ...
        <div className="bg-white/80 w-[535px] h-9/12 rounded-tr-[110px] shadow-md absolute top-38" />
        <div>
          <div className="bg-white w-[520px] h-fit rounded-tr-[110px] p-9 absolute top-41 shadow-lg">
            ...
            <p className="text-black py-2 text-lg text-left px-2 leading-8">
              FlagSHIP happens sophomore year. Here’s the thing: You will love it. The
              courses are challenging but worth it. And at the end, you’ll pack your bags
              and head out with your class.
            </p>

            <p className="text-black py-2 text-lg text-left px-3 leading-8">
              Explore Scotland&apos;s hospitality, tackle Jordan&apos;s water scarcity, or
              dive into Costa Rican farming.
            </p>
