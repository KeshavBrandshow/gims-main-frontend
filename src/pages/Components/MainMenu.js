...
const MainMenu = () => {
  const [isExploreFlaglerOpen, setIsExploreFlaglerOpen] = useState(false);
  ...
  const sitesAndTools = [
    { name: 'MyFlagler', icon: 'my', url: '#' },
    { name: 'Saints Connect', icon: '🏛️', url: '#' },
    { name: 'Canvas', icon: '🎨', url: '#' },
    { name: 'Academic Catalog', icon: '📚', url: '#' },
    { name: 'Deposit', icon: '💰', url: '#' },
    { name: 'Net Price Calculator', icon: '🧮', url: '#' },
    { name: 'Bookstore', icon: '📚', url: '#' },
    { name: 'Proctor Library', icon: '🏛️', url: '#' },
    { name: 'Parking Portal', icon: '🚗', url: '#' },
    { name: 'Planned Giving', icon: '🌿', url: '#' },
  ];
  ...
  const megaMenuContent = {
    aboutgims: {
      title: 'About GIMS',
      sections: [
        { title: 'History', type: 'link', url: '#' },
        { title: 'Vision & Mission', type: 'link', url: '#' },
        { title: 'Founder Chairman\'s Message', type: 'link', url: '#' },
        { title: 'Chairman\'s Message', type: 'link', url: '#' },
        { title: 'CEO Message', type: 'link', url: '#' },
        { title: 'Director\'s Message', type: 'link', url: '#' },
        { title: 'Executive Director', type: 'link', url: '#' },
        { title: 'Dean Academics', type: 'link', url: '#' },
        { title: 'Dean-Outreach & Student Welfare', type: 'link', url: '#' },
        { title: 'Accreditation', type: 'link', url: '#' },
        { title: 'Audited Statements', type: 'link', url: '#' },
      ]
    },
    program: {
      title: 'Program',
      sections: [
        { title: 'Post Graduate Diploma in Management (PGDM)', type: 'link', url: '#' },
        {
          title: 'PGDM Details',
          type: 'expandable',
          items: [
            { name: 'About PGDM@GIMS', url: '#' },
            { name: 'Program Highlights', url: '#' },
            { name: 'PGDM Specializations', url: '#' },
            { name: 'Self Directed Learning', url: '#' },
            { name: 'Certifications', url: '#' },
            { name: 'Course structure and curriculum', url: '#' },
          ]
        },
        {
          ...
          type: 'expandable',
          items: [
            { name: 'Foreign National Courses', url: '#' },
            { name: 'Working Professional Courses', url: '#' },
          ]
        },
      ]
    },
    admission: {
      title: 'Admission',
      sections: [
        { title: 'Admission @ GIMS', type: 'link', url: '#' },
        { title: 'Message of the Dean- Outreach and Student Welfare(OSW)', type: 'link', url: '#' },
        { title: 'Selection Process', type: 'link', url: '#' },
        { title: 'Fee Structure', type: 'link', url: '#' },
        { title: 'Education Loan', type: 'link', url: '#' },
        { title: 'GIMS Admission Form', type: 'link', url: '#' },
        { title: 'Eligibility Criteria', type: 'link', url: '#' },
        { title: 'Scholarship', type: 'link', url: '#' },
        { title: 'Intellectual Capital @ GIMS', type: 'link', url: '#' },
      ]
    },
    crc: {
      title: 'Corporate Resource Centre',
      sections: [
        { title: 'About CRC', type: 'link', url: '#' },
        { title: 'Our Recruiters', type: 'link', url: '#' },
        { title: 'Placements', type: 'link', url: '#' },
        { title: 'Industry Interface', type: 'link', url: '#' },
        { title: 'Team- CRC', type: 'link', url: '#' },
        { title: 'Placement Brochure', type: 'link', url: '#' },
      ]
    },
    councils: {
      title: 'Councils',
      sections: [
        { title: 'Board of Governors', type: 'link', url: '#' },
        { title: 'Corporate & Academic Advisory Board', type: 'link', url: '#' },
        { title: 'CRC Council', type: 'link', url: '#' },
      ]
    },
    lifeatgims: {
      title: 'Life @ GIMS',
      sections: [
        { title: 'Gallery', type: 'link', url: '#' },
        { title: 'Campus', type: 'link', url: '#' },
        { title: 'Academics', type: 'link', url: '#' },
        { title: 'Mentorship', type: 'link', url: '#' },
        { title: 'Sports', type: 'link', url: '#' },
        { title: 'Music Room', type: 'link', url: '#' },
        { title: 'IT Infrastructure', type: 'link', url: '#' },
        { title: 'Clubs @ GIMS', type: 'link', url: '#' },
        { title: 'Anti Ragging', type: 'link', url: '#' },
        { title: 'Hostel Life', type: 'link', url: '#' },
        { title: 'Life at GIMS', type: 'link', url: '#' },
      ]
    },
    faculty: {
      title: 'Faculty',
      sections: [
        { title: 'Faculty Directory', type: 'link', url: '#' },
      ]
    },
    arb: {
      title: 'ARB',
      sections: [
        { title: 'ARB Information', type: 'link', url: '#' },
      ]
    },
    accreditation: {
      title: 'Accreditation',
      sections: [
        { title: 'Accreditation Details', type: 'link', url: '#' },
      ]
    },
    disclosure: {
      title: 'Mandatory Disclosure',
      sections: [
        { title: 'Disclosure Information', type: 'link', url: '#' },
      ]
    }
  };
        ...
        <div className="border-b border-white border-opacity-20">
          <div className="max-w-[1400px] mx-auto px-4 lg:px-8">
            <div className="hidden md:flex justify-end items-center gap-3 py-2 text-sm overflow-x-auto">
              ...
              <button 
                onClick={() => setIsExploreFlaglerOpen(true)}
                className="text-white hover:text-[#FFC300] transition-all whitespace-nowrap px-2 py-1 hover:bg-white/10 rounded text-xs"
              >
                More +
              </button>
            </div>
              ...
              <div className="hidden lg:flex items-center gap-6">
                {['aboutgims', 'program', 'admission', 'crc'].map((key) => (
                  <button
                    ...
                    className={`text-white hover:text-[#FFC300] transition-colors text-sm font-medium ${activeMegaMenu === key ? 'font-bold text-[#FFC300]' : ''}`}
                  >
                    {megaMenuContent[key].title}
                  </button>
                ))}
                <button className="p-2 text-white hover:text-[#FFC300] transition-colors"><Search className="w-5 h-5" /></button>
              </div>
              
              <button onClick={() => setIsExploreFlaglerOpen(true)} className="flex items-center gap-2 px-4 py-2 bg-white text-gray-800 hover:bg-[#FFC300] hover:text-[#033E96] transition-all rounded font-semibold text-sm">
                          ...
                          {section.type === 'link' ? (
                            ...
                            <div>
                              <button
                                ...
                                className={`w-full flex items-center justify-between py-2 group transition-all duration-300 relative ${isExpanded ? 'text-[#822433] pl-8' : 'text-gray-900 hover:text-[#822433] pl-0 hover:pl-8'}`}
                              >
          ...
          <div className="min-h-screen">
            <div className="bg-[#033E96] border-b border-[#0451C4]">
              <div className="max-w-[1400px] mx-auto px-4 lg:px-8 py-4 flex items-center justify-between">
                ...
                <button
                  onClick={() => setIsExploreFlaglerOpen(false)}
                  className="text-white hover:text-[#FFC300] transition-colors flex items-center gap-2"
                >
                  <X className="w-6 h-6" />
            ...
            <div className="max-w-[1400px] mx-auto px-4 lg:px-8 py-8">
              ...
              <div className="lg:hidden space-y-8">
                {/* Search First */}
                <div>
                  <h2 className="text-white text-2xl font-serif mb-6">Search Flagler.edu</h2>
                ...
                <div className="space-y-1">
                  {[
                    { title: 'Academics', items: ['Degrees & Programs', 'Graduate and Education Programs', 'Signature Programs', 'Academic Support', 'Academic Calendar', 'Academic Projects', 'Flagler College Tallahassee Legacy'] },
                    ...
                    return (
                      <div key={index} className="border border-white/30 rounded-none overflow-hidden">
                        <button
                          ...
                          className={`w-full flex items-center justify-between px-4 py-4 text-white transition-all duration-300 group relative ${
                            isExpanded ? 'bg-white/10' : 'hover:bg-white/5'
                          }`}
                        >
                          <div className="flex items-center">
                            <span className={`absolute left-4 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 text-[#FFC300] text-xl font-light mr-3 ${
                              isExpanded ? 'opacity-0' : ''
                            }`}>→</span>
                            <span className={`font-bold text-lg text-left transition-all duration-300 ${
                              isExpanded ? 'pl-0' : 'group-hover:pl-8'
                            }`}>{section.title}</span>
                          </div>
              ...
              <div className="hidden lg:grid lg:grid-cols-3 gap-8 lg:gap-12">
                ...
                <div className='col-span-2'>
                  <div className="mb-8">
                    <h2 className="text-white text-3xl font-serif mb-6">Search Flagler.edu</h2>
                    <div className="relative">
                      <input
                        type="text"
                        placeholder="Search..."
                      ...
                      {[
                        ...
                        return (
                          <div key={index} className="border border-white/30 rounded-none overflow-hidden">
                            <button
                              onClick={() => toggleSection(sectionKey)}
                              className={`w-full flex items-center justify-between px-4 lg:px-6 py-4 text-white transition-all duration-300 group relative ${
                                isExpanded ? 'bg-white/10' : 'hover:bg-white/5'
                              }`}
                            >
                              <div className="flex items-center">
                                <span className={`absolute left-4 lg:left-6 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 text-[#FFC300] text-xl font-light mr-3 ${
                                  isExpanded ? 'opacity-0' : ''
                                }`}>→</span>
                                <span className={`font-bold text-lg lg:text-xl text-left transition-all duration-300 ${
                                  isExpanded ? 'pl-0' : 'group-hover:pl-8'
                                }`}>{section.title}</span>
                              </div>
                              <div className={`transition-all duration-300 ${
                  ...
                  <div className="mt-8 flex flex-col lg:flex-row items-center justify-between gap-4">
                    ...
                    <div className="text-white text-center lg:text-right">
                      <div className="font-serif italic text-2xl lg:text-3xl">Flagler forward</div>
                      <div className="text-sm opacity-75 tracking-wider">THE CAMPAIGN FOR FLAGLER COLLEGE</div>
                    </div>
                  </div>
                </div>
              </div>
