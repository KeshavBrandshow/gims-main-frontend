...
export default function StatsSection() {
  return (
    <section className="bg-secondary">
      {/* 8xl container centered */}
      <div className="max-w-8xl mx-auto px-4 py-12 lg:py-20 ">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-stretch gap-10 lg:gap-16">
          {/* Left: stats */}
          <div className="w-full lg:w-1/2 flex flex-col justify-center items-center text-center lg:text-left lg:pl-50">
            <div className="grid gap-10 lg:gap-16 lg:grid-cols-3">
              ...
              <div>
                ...
                <p className="main-text text-sm lg:text-base leading-relaxed max-w-xs">
                  of our students study abroad, away, or in the community
              ...
              <div>
                ...
                <p className="main-text text-sm lg:text-base leading-relaxed max-w-xs">
                  of our students were employed, interning, or pursuing further
              ...
              <div>
                ...
                <p className="main-text text-sm lg:text-base leading-relaxed max-w-xs">
                  our student-to-teacher ratio fosters close professor
                  relationships.
                </p>
              </div>
            </div>
